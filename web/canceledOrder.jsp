    ...
    <body>
        <c:if test="${requestScope.alert!=null}">
         ...
         <%
            ...
            ArrayList<Order> list = (ArrayList<Order>) OrderDAO.getCanceledOrder(email);
            if (name == null) {
        %>
        ...
        <section><!--load all orders-->
            ...
            <table class="table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><a href="OrderDetail.jsp?orderid=<%= tmp.getOrderID()%>">detail
                                    <a href="mainController?action=orderagain&orderid=<%=tmp.getOrderID()%>" style="margin-left: 30px">Order again</a>
                                </a>
                            </td>
                        </tr>
                    </tbody>
            ...
            <%
                ...
                else{%><p>You don't have any canceled order</p><%} 
            %>
